...
loss observations with confidence annotations.
...
seed includes a concrete decision-delta: \texttt{C57} (better local runtime)
versus \texttt{C52} (lower transfer burden) demonstrates objective-dependent
choice.
...
\subsection{Incident Linkage for CQ4}
...
\subsection{Seed Artifact Status}
