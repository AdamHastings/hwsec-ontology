...
they \emph{induce}. Incident entities capture contingent and reputational losses,
while incentive-misalignment relations capture systematic cost transfer.
...
operator, enterprise customer, end user, regulator/public), timing (upfront,
recurring, contingent, deferred), bearing mode (internalized, transferred,
insured, externalized), and evidence type (measured, estimated, or
...
class), and counterfactual opportunity cost (which alternative capability would
have used the same area, power, or budget). This distinction is essential for
...
location tag. Companion incident and VOI artifacts extend this to loss
attribution and measurement-priority analysis.
